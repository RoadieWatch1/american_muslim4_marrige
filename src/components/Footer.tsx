...
//               {/* <li><button onClick={() => scrollToSection("blog")} className="hover:text-teal-400">Blog</button></li> */}
//             </ul>
//           </div>
//           <div>
//             <h4 className="text-white font-semibold mb-4">Support</h4>
...
//               <li><button onClick={() => setContactOpen(true)} className="hover:text-teal-400">Contact Us</button></li>
//               <li><button onClick={() => scrollToSection("faq")} className="hover:text-teal-400">Help Center</button></li>
//             </ul>
//           </div>
//           <div>
//             <h4 className="text-white font-semibold mb-4">Legal</h4>
